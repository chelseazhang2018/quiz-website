...
public class MyDBInfo {
	...
	public static final String MYSQL_USERNAME = "ccs108wwang23";
	public static final String MYSQL_PASSWORD = "mpP2jB2FbRhjnnQk";
	public static final String MYSQL_DATABASE_SERVER = "mysql-user.stanford.edu";
	public static final String MYSQL_DATABASE_NAME = "c_cs108_wwang23";
