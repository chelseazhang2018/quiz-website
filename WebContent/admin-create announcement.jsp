...
<form class="form-signin"  action="createNewAnnouncement" method="post">
    Announcement Content: <input class="form-control" type="text" name="content"/> <br/>
      
    <input class="btn btn-lg btn-primary btn-block" type="submit" value="Create Announcement"/>
</form>
