...
<title>Edit Picture Response</title>
...
<form action="quizEdited" method="post">
    Image Location: <input class="form-control" type="text" name="image location"/> <br/>
    Answer(use "@#" to separate multiple answers): <input class="form-control" type="text" name="answer"/> <br/>
