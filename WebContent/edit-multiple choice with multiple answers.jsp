...
<body>
<form action="edit-multiple choice with multiple answers2.jsp" method="post">

        Number of Options: <input class="form-control" type ="text" name = "option number"/> <br/>
    Number of Answers: <input class="form-control" type ="text" name = "answer number"/> <br/>
