...
<body>
<form action="create-multiple choice with multiple answers2.jsp" method="post">

        Number of Options: <input class="btn btn-primary" type ="text" name = "option number"/> <br/>
    Number of Answers: <input class="btn btn-primary" type ="text" name = "answer number"/> <br/>
