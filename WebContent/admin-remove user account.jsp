...
for (int i = 0; i < users.size(); i++){
	...
	<form  action="removeUserAccount" method="post">
	<a href="friend-profile.jsp?submit=<%=nameToPrint%>"><%=nameToPrint%></a>
	<input class="form-control" type="hidden" value="<%=nameToPrint %>" name = "username" style = "display: inline;"/>
    <input class="btn btn-warning" type="submit" value="Remove User" style = "display: inline;"/>    
    </form>
	<br/>
	<%
	}
